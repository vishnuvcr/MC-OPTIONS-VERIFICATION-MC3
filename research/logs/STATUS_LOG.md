...
| PV-15 | Provider normalization correction | IN PROGRESS | Live dashboard exposed two code defects after PV-14: SENSEX router import was missing, and indiaopt OptionChainResult object rows were not normalized because the adapter only handled dict/list payloads. Both are being corrected on a dedicated branch. |
